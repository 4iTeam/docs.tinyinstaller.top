...
Parameters:\
`setup_url`: Setup URL obtained from the [Access Info Api](api-requests.md#get-access-info)\
`key`: Setup key obtained from the [Access Info Api](api-requests.md#get-access-info)
